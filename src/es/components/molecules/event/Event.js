      ...
      <div class="details">
        ...
        <div class="details-right">
          ...
          <div>
            <h3>
              <div class="abo">A</div>
              <span>${data.abo_label}</span>
            </h3>
            <div>
              <ks-m-system-notification namespace="system-notification-default-" icon-name="Percent" with-icon-background>
                  <div slot="description">
                      <p>${data.abo_info_label}</p>
                      <a-link namespace="underline-">
                          <a href="${data.abo_link}">
                            <span>${data.abo_link_label}</span>
                          </a>
                      </a-link>
                  </div>
              </ks-m-system-notification>
            </div>
            <a class="link-more" href="${data.abo_link_more}">
              <span>${data.abo_link_more_label}</span>
              <a-icon-mdx namespace="icon-mdx-ks-event-link-" icon-name="ArrowRight" size="1em" class="icon-right"></a-icon-mdx>  
            </a>
          </div>   
        </div>
      </div>
