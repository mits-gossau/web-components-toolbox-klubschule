  ...
  */
  renderHTML (aboDetail) {
    ...
    this.html = /* html */ `
      ...
      <div>
        <ks-m-buttons course-data='${JSON.stringify(aboDetail).replace(/'/g, '’')}' is-abo${this.hasAttribute('tracking-context') ? ` tracking-context="${this.getAttribute('tracking-context')}"` : ''}></ks-m-buttons>
      <div>
    `
