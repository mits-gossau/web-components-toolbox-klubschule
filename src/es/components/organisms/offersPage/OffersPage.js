  ...
  renderHTML() {
    this.html = /* html */`
      ...
      >
        <ks-c-partner-search 
          ${this.hasAttribute('initial-request') ? ` initial-request='${this.getAttribute('initial-request').replace(/'/g, '’').replace(/"/g, '\"')}'` : ''} 
          ${this.hasAttribute('endpoint-search-partner') ? `endpoint="${this.getAttribute('endpoint-search-partner')}"` : ''}
          ${this.hasAttribute("alternative-portal-ids-search") ? ` alternative-portal-ids-search="${this.getAttribute("alternative-portal-ids-search")}"` : ''}
        >
          ${this.hasAttribute('with-main-search-input') ? this.mainSearchInput : /* html */``} 
      ...
      <div col-lg="6" col-md="6" col-sm="12">
        ...
        >
          <m-dialog 
            ...
            id="keyword-search" 
            show-event-name="show-search-dialog" 
            close-event-name="close-search-dialog" 
            dialog-mobile-height="100vh" 
            dialog-desktop-height="40%"
          >
            <dialog>
              <div class="container">
                <a-input
    ...
    const locationInput = this.hasAttribute('with-location-input') ? /* html */`
      <div col-lg="6" col-md="6" col-sm="12">
        ...
        >
            <m-dialog 
              namespace="dialog-top-slide-in-" 
              show-event-name="show-location-search-dialog" 
              id="location-search" 
              close-event-name="close-location-dialog" 
              dialog-mobile-height="100vh" 
              dialog-desktop-height="40%"
            >
              <dialog>
