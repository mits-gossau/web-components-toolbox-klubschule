...
<<<<<<< HEAD
                tracking-context="${this.getAttribute('tracking-context') || (this.hasAttribute('is-info-events') ? 'info_session' : this.hasAttribute('is-other-locations') ? 'other_locations' : this.isWishList ? 'wishlist_offers' : 'offers_list')}"
=======
