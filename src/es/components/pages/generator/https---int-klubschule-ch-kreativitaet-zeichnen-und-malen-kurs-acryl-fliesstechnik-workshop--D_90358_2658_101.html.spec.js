    ...
    test('https---int-klubschule-ch-kreativitaet-zeichnen-und-malen-kurs-acryl-fliesstechnik-workshop--D_90358_2658_101.html', async ({ page, browserName }) => {
      await page.goto('./src/es/components/web-components-toolbox/docs/TemplateMiduweb.html?rootFolder=src&css=./src/css/variablesCustomKlubschule.css&login=./src/es/components/molecules/login/default-/default-.html&logo=./src/es/components/atoms/logo/default-/default-.html&nav=./src/es/components/web-components-toolbox/src/es/components/molecules/multiLevelNavigation/default-/default-.html&footer=./src/es/components/organisms/footer/default-/default-.html&content=./src/es/components/pages/generator/https---int-klubschule-ch-kreativitaet-zeichnen-und-malen-kurs-acryl-fliesstechnik-workshop--D_90358_2658_101.html')
